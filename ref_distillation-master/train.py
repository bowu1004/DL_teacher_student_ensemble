...
def train(model, model_label, training_data, batch_size=256, epochs=10):
    ...
    print(f'number of classes is {nb_classes}')
    y_train -= 1  # BW: np_utils.to_categorical from 0 to number of classes
    y_test -= 1  # BW: np_utils.to_categorical from 0 to number of classes
    ...
    # BW: comment below line because tensorboard recalls Tensorflow.keras while the rest of the code relies on Keras.
